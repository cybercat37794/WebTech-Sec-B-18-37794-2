		...
		<?php foreach ($students as $i => $student): ?>
			...
			<tr>
				...
				<td><a href="editUser.php?id=<?php echo $student['user_id'] ?>">Edit</a>
					&nbsp
					<a href="controller/deleteUser.php?id=<?php echo $student['user_id'] ?>" onclick="deleteAlart()">Delete Account</a>					
				</td>
				<br>
...
function deleteAlart() 
{
    ...
    alert("Are you you sure you want to delete this account?");
